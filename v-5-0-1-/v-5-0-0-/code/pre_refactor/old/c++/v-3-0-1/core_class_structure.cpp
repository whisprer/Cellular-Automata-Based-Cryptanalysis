/*****************************************************
 * File: core_class_structure.cpp
 *****************************************************/
#include "core_class_structure.hpp"
#include <iostream>
// #include "bitsequence.hpp"    // if needed
// #include "nist_sts.hpp"       // if needed

namespace caca {

void Core::execute(const Options& options) {
    std::cout << "[Core::execute] Running with inputFile=" << options.inputFile 
